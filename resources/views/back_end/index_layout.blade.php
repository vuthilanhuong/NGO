                    ...
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-edit"></i> User <span class="fa fa-chevron-down"></span></a>
                                <ul >
                                    <li><a href="{{url('user')}}">List of User</a></li>
                                    <li><a href="{{url('user/create')}}">Form create User</a></li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-desktop"></i> Member <span class="fa fa-chevron-down"></span></a>
                                <ul >
                                    <li><a href="{{url('member')}}">List of Member</a></li>
                                    <li><a href="{{url('member/create')}}">Form create Member</a></li>
                                </ul>
                            </li>
