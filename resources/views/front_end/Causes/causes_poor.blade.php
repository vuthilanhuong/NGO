...
<body>
        ...
        <div class="banner_inner d-flex align-items-center">
            ...
            <div class="container">
                <div class="banner_content text-center">
                    ...
                    <p>Welfare activities help the poor</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="event_area section_gap">
        <div class="container">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="content_wrapper">
                                    <h3 class="title">
                                        <a href="http://localhost/NGO-v3/public/front/detail_up">Poor old people</a>
                                    </h3>
                                    <p>
                                    ...
                                    <div class="d-flex justify-content-between donation align-items-center">
                                        <a href="http://localhost/NGO-v3/public/front/registration"><button type="button" class="btn btn-outline-success">Register</button></a>
                                        <a href="http://localhost/NGO-v3/public/front/detail_up"><button type="button" class="btn btn-outline-success">Learn More</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="single_event">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6">
                                <figure>
                                    <img class="img-fluid w-100" src="../client/img/poor/ev2.jpg" alt="">
                                    <div class="img-overlay"></div>
                                </figure>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="content_wrapper">
                                    <h3 class="title">
                                        <a href="http://localhost/NGO-v3/public/front/detail_up">Food for the poor</a>
                                    </h3>
                                    <p>
                                        Provide more food, water and essential items for the poor in poor rural areas around the world
                                    </p>
                                    <div class="d-flex justify-content-between raised_goal">
                                        <p>Registered: 3108</p>
                                        <p><span class="lnr lnr-heart"></span> 150 Donors</p>
                                    </div>
                                    <div class="d-flex justify-content-between donation align-items-center">
                                        <a href="http://localhost/NGO-v3/public/front/registration"><button type="button" class="btn btn-outline-success">Register</button></a>
                                        <a href="http://localhost/NGO-v3/public/front/detail_up"><button type="button" class="btn btn-outline-success">Learn More</button></a>
                ...
                <div class="col-lg-6">
                    <div class="single_event">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6">
                                <figure>
                                    <img class="img-fluid w-100" src="../client/img/poor/ev3.jpg" alt="">
                                    <div class="img-overlay"></div>
                                </figure>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="content_wrapper">
                                    <h3 class="title">
                                        <a href="http://localhost/NGO-v3/public/front/detail_up">Poor children, women</a>
                                    </h3>
                                    <p>
                                        Poor children and women in rural areas are increasing because of fertility problems
                                    </p>
                                    <div class="d-flex justify-content-between raised_goal">
                                        <p>Registered: 2466</p>
                                        <p><span class="lnr lnr-heart"></span> 102 Donors</p>
                                    </div>
                                    <div class="d-flex justify-content-between donation align-items-center">
                                        <a href="http://localhost/NGO-v3/public/front/registration"><button type="button" class="btn btn-outline-success">Register</button></a>
                                        <a href="http://localhost/NGO-v3/public/front/detail_up"><button type="button" class="btn btn-outline-success">Learn More</button></a>
                ...
                <div class="col-lg-6">
                    <div class="single_event">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6">
                                <figure>
                                    <img class="img-fluid w-100" src="../client/img/poor/ev4.jpg" alt="">
                                    <div class="img-overlay"></div>
                                </figure>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="content_wrapper">
                                    <h3 class="title">
                                        <a href="http://localhost/NGO-v3/public/front/detail_up">Health for the poor</a>
                                    </h3>
                                    <p>
                                        Health for the poor is an issue that needs attention now, helping the poor avoid disease
                                    </p>
                                    <div class="d-flex justify-content-between raised_goal">
                                        <p>Registered: 2832</p>
                                        <p><span class="lnr lnr-heart"></span> 178 Donors</p>
                                    </div>
                                    <div class="d-flex justify-content-between donation align-items-center">
                                        <a href="http://localhost/NGO-v3/public/front/registration"><button type="button" class="btn btn-outline-success">Register</button></a>
                                        <a href="http://localhost/NGO-v3/public/front/detail_up"><button type="button" class="btn btn-outline-success">Learn More</button></a>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <figure>
                                <img class="card-img-top img-fluid" src="../client/img/poor/fc1.jpg" alt="Card image cap">
                            </figure>
                            <div class="card_inner_body">
                                <h4 class="card-title">House for the poor</h4>
                                <p class="card-text">
                                    The poor need the most to live in a stable place, help them to have a home, to integrate into the community
                                </p>
                                <div class="d-flex justify-content-between raised_goal">
                                ...
                                <div class="d-flex justify-content-between donation align-items-center">
                                    <a href="http://localhost/NGO-v3/public/front/detail_fe"><button type="button" class="btn btn-outline-success">Learn More</button></a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <figure>
                                <img class="card-img-top img-fluid" src="../client/img/poor/fc2.jpg" alt="Card image cap">
                            </figure>
                            <div class="card_inner_body">
                                <h4 class="card-title">Poor community</h4>
                                <p class="card-text">
                                    The poor community is spontaneously spontaneous, they need support from people all over the world
                                </p>
                                <div class="d-flex justify-content-between raised_goal">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <figure>
                                <img class="card-img-top img-fluid" src="../client/img/poor/fc3.jpg" alt="Card image cap">
                            </figure>
                            <div class="card_inner_body">
                                <h4 class="card-title">Disease outbreaks</h4>
                                <p class="card-text">
                                    Epidemic diseases in poor people make their lives difficult and increase the number of deaths every year
                                </p>
                                <div class="d-flex justify-content-between raised_goal">
    ...
    <!--================ Start Causes Area =================-->
    <section class="causes_area_causes">
        <div class="container">
            <div class="main_title">
