        ...
        <div class="banner_inner d-flex align-items-center">
            ...
            <div class="container">
                <div class="banner_content text-center">
                    <h2>Support Homless</h2>
                    <p>Welfare activities help homeless in difficult circumstances</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-6">
                    <div class="single_event">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6">
                                <figure>
                                    <img class="img-fluid w-100" src="../client/img/homeless/ev2.jpg" alt="">
                                    <div class="img-overlay"></div>
                                </figure>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="content_wrapper">
                                    <h3 class="title">
                                        <a href="event-details.html">Old people wandering</a>
                                    </h3>
                                    <p>
                                        Old people roam the streets, begging to live through the day because there is no place to live
                                    </p>
                                    <div class="d-flex justify-content-between raised_goal">
                                        <p>Registered: 3108</p>
                ...
                <div class="col-lg-6">
                    <div class="single_event">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6">
                                <figure>
                                    <img class="img-fluid w-100" src="../client/img/homeless/ev3.jpg" alt="">
                                    <div class="img-overlay"></div>
                                </figure>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="content_wrapper">
                                    <h3 class="title">
                                        <a href="event-details.html">Social problems</a>
                                    </h3>
                                    <p>
                                        The poor, homeless and homeless people are becoming worrying for the current society
                                    </p>
                                    <div class="d-flex justify-content-between raised_goal">
                                        <p>Registered: 2466</p>
                ...
                <div class="col-lg-6">
                    <div class="single_event">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6">
                                <figure>
                                    <img class="img-fluid w-100" src="../client/img/homeless/ev4.jpg" alt="">
                                    <div class="img-overlay"></div>
                                </figure>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="content_wrapper">
                                    <h3 class="title">
                                        <a href="event-details.html">Help them go home</a>
                                    </h3>
                                    <p>
                                        Help the homeless, the homeless return home, give them a place to stay, have things to eat
                                    </p>
                                    <div class="d-flex justify-content-between raised_goal">
                                        <p>Registered: 2832</p>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <figure>
                                <img class="card-img-top img-fluid" src="../client/img/homeless/fc1.jpg" alt="Card image cap">
                            </figure>
                            <div class="card_inner_body">
                                <h4 class="card-title">Seeking human kindness</h4>
                                <p class="card-text">
                                    Search for human kindness in the bottom of the society, the nooks and crannies of the street
                                </p>
                                <div class="d-flex justify-content-between raised_goal">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <figure>
                                <img class="card-img-top img-fluid" src="../client/img/homeless/fc2.jpeg" alt="Card image cap">
                            </figure>
                            <div class="card_inner_body">
                                <h4 class="card-title">Feeding the hungry people</h4>
                                <p class="card-text">
                                    Feed hungry people, homeless people in the city, help them integrate more with the community
                                </p>
                                <div class="d-flex justify-content-between raised_goal">
