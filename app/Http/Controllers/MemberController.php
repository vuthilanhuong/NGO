...
class MemberController extends Controller
{
    ...
    public function MemberSave(Request $request){
        ...
        return redirect("member")->with("message","Add new member successfully");
    }
    ...
    public function Memberpdate(Request $request){
        ...
        if($member){
            ...
            return redirect("member")->with("message","Update successfully");
        }else{
    ...
    public function MemberSearch(Request $request){
        ...
        return redirect("member/search?searchValue=".$searchValue);
    }
